package net.mcreator.megastones.mixins;
...
public abstract class MegastonesModRepairItemRecipeMixin {
	...
	public void assemble(CraftingContainer craftingContainer, CallbackInfoReturnable<ItemStack> cir) {
		...
		if ((itemStack3 = (ItemStack) list.get(0)).is((MegastonesModItems.CHARIZARD_X))) {
