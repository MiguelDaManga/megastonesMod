...
package net.mcreator.megastones.world.inventory;
...
public class GUIMenu extends AbstractContainerMenu {
	...
	public GUIMenu(int id, Inventory inv, Container container) {
		super(MegastonesModMenus.GUI, id);
